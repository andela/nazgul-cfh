...
describe('Gaming Screen Page', () => {
  ...
  it('should have a title of "Cards for Humanity - Development"', () => {
    expect(browser.getCurrentUrl()).toEqual('http://localhost:3001/#!/app');
  });
  ...
  it('should have a timer description"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(timerdesc)).toBe(true);
    });
  });
  ...
  it('should have a section that shows start game button"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(startGameBtn)).toBe(true);
    });
  });
  ...
  it('should have an information section when a game ends"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(endGameInfo)).toBe(true);
    });
  });
  ...
  it('should show the Czar"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(showCzar)).toBe(true);
    });
  });
  ...
  it('should show "How To Play" section"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(showHowToPlay)).toBe(true);
    });
  });
  ...
  it('should show charity widget"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(showCharityWidget)).toBe(true);
    });
  });
  ...
  it('should have a section that shows the answers"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(showAnsCards)).toBe(true);
    });
  });
  ...
  it('should show the scoreboard for all players"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(showScoreboard)).toBe(true);
    });
  });
  ...
  it('should put a marker on the current player"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(showCurrentPlayer)).toBe(true);
    });
  });
  ...
  it('should put czar-marker on the czar player"', () => {
    browser.sleep(10).then(() => {
      ...
      expect(browser.isElementPresent(showCzarMarker)).toBe(true);
    });
  });
});
